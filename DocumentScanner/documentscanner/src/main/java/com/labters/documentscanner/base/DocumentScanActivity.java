...
public abstract class DocumentScanActivity extends AppCompatActivity {
    ...
    private void initializeCropping() {
        ...
        try {
            ...
            getPolygonView().setPointColor(getResources().getColor(R.color.polygonViewCircleStrokeColor));
            Log.e("TAG", "initializeCropping: done");
