...
final class BitmapUtils {
  ...
  static Rect getRectFromPoints(
      ...
      int aspectRatioX,
      int aspectRatioY) {
//    Log.e("TAG", "getRectFromPoints: left "+getRectLeft(points));
//    Log.e("TAG", "getRectFromPoints: right "+getRectRight(points)+" Points : ");
//    printPoints(points);
//    Log.e("TAG", "getRectFromPoints: top "+getRectTop(points));
//    Log.e("TAG", "getRectFromPoints: bottom "+getRectBottom(points));
...
//    Log.e("TAG", "getRectFromPoints: rect : "+rect);
  ...
  private static void printPoints(float[] points)
  {
    ...
    {
//      Log.e("TAG", "getRectFromPoints printPoints: "+point);
    }
  }
